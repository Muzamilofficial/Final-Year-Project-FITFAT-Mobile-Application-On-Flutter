...
class ShowWorkout extends StatefulWidget {
  ...
  @override
  State<ShowWorkout> createState() => _DietUsersState();
}

class _DietUsersState extends State<ShowWorkout> {
...
//   });
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection('mk@gmail.com');
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(documentSnapshot['Exercise'].toString()),
                    trailing: SizedBox(
                      width: 100,
                      child: Row(
                        children: [
