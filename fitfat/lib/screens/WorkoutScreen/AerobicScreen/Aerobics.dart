...
import 'AirSquatsvideoscreen.dart';
import 'Armcirclesvideoscreen.dart';
import 'JoggingInPlacevideoscreen.dart';
import 'Singlelegstandvideoscreen.dart';
import 'TrunkRotation.dart';

class Aerobics extends StatefulWidget {
  Aerobics();

  @override
  State<Aerobics> createState() => _AerobicsState();
}

class _AerobicsState extends State<Aerobics> {
            ...
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                  ...
                  'Exercise':'Singlelegstand',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Singlelegstandvideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Armcirclesvideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'TrunkRotation',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Trunkrotationvideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => AirSquatsvideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise':'JoggingInPlace',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => JoggingInPlacevideoscreen()));
              }),
            ),
          ),
          SizedBox(height: 20,),
