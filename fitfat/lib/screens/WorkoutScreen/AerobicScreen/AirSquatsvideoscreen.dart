...
class AirSquatsvideoscreen extends StatefulWidget {
  AirSquatsvideoscreen();

  @override
  _VideoDisplayState createState() => _VideoDisplayState();
}

class _VideoDisplayState extends State<AirSquatsvideoscreen> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
