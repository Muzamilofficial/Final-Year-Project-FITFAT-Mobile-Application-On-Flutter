...
class Trunkrotationvideoscreen extends StatefulWidget {
  Trunkrotationvideoscreen();

  @override
  _VideoDisplayState createState() => _VideoDisplayState();
}

class _VideoDisplayState extends State<Trunkrotationvideoscreen> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: VideoPlayer(
          ...
          videoPlayerController: VideoPlayerController.network(
              'https://www.youtube.com/watch?v=LyiS74HzQOQ'),
        ),
      ),
