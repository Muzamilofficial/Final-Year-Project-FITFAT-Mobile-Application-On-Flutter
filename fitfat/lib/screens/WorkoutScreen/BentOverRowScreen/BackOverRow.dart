...
import 'Widegripvideoscreen.dart';

class BackOverRow extends StatelessWidget {
  BackOverRow();
            ...
            child: InkWell(
              ...
              onTap: (() async {
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Widegripvideoscreen()));
              }),
            ),
          ),SizedBox(
            height: 20,
