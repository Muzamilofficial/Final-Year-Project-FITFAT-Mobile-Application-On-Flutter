...
import 'package:fitfat/screens/WorkoutScreen/LugesScreen/WalkingLunge.dart';
...
import 'DeficitLunge.dart';
import 'ForwardLungevideoscreen.dart';
import 'ReverseLunge.dart';
            ...
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                 ...
                 'Exercise': 'ForwardLunge',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => ForwardLungevideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => ReverseLunge()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                 'Exercise': 'WalkingLunge',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => WalkingLunge()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'DeficitLunge',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => DeficitLunge()));
              }),
            ),
          ),SizedBox(
            height: 20,
