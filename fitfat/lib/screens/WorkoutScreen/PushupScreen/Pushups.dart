...
import 'package:fitfat/screens/WorkoutScreen/PushupScreen/Aztec.dart';
import 'package:fitfat/screens/WorkoutScreen/PushupScreen/Decline.dart';
import 'package:fitfat/screens/WorkoutScreen/PushupScreen/OnearmPushup.dart';
import 'package:fitfat/screens/WorkoutScreen/PushupScreen/Widegrip.dart';
...
import 'BehindTheClap.dart';
import 'DiamondPushup.dart';
import 'Frontclap.dart';
import 'Incline.dart';
        ...
        children: [
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Widegrip' + getCurrentDate();
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Widegrip()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'diamond' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'DiamondPushup',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => DiamondPushup()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Frontclap' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Frontclap()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Behindclap' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'BehindTheClap',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => BehindTheClap()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Onearm' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'OnearmPushup',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => OnearmPushup()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Decline' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Decline()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Incline' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Incline()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Staggered' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'Staggered Pushup',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Staggered()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Aztec' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'Aztec Pushup',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Aztec()));
              }),
            ),
          ),
          SizedBox(
