...
import 'package:fitfat/screens/WorkoutScreen/SquatsScreen/Split.dart';
            ...
            child: InkWell(
              ...
              onTap: (() async {
                ...
                await users.doc(docname).set({
                 ...
                 'Exercise': 'Barbellfront',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Barbellfront()));
              }),
            ),
          ),
          SizedBox(
