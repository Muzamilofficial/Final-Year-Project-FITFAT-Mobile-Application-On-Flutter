...
class Cobraposevideoscreen extends StatefulWidget {
  Cobraposevideoscreen();

  @override
  _VideoDisplayState createState() => _VideoDisplayState();
}

class _VideoDisplayState extends State<Cobraposevideoscreen> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: VideoPlayer(
          ...
          videoPlayerController: VideoPlayerController.network(
              'https://www.youtube.com/watch?v=jwoTJNgh8BY'),
        ),
      ),
