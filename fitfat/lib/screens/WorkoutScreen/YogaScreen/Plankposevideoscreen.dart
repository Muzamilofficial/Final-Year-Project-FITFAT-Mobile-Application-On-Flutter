...
class Plankposevideoscreen extends StatefulWidget {
  Plankposevideoscreen();

  @override
  _VideoDisplayState createState() => _VideoDisplayState();
}

class _VideoDisplayState extends State<Plankposevideoscreen> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: VideoPlayer(
          ...
          videoPlayerController: VideoPlayerController.network(
              'https://www.youtube.com/watch?v=OMR5ikcgWaI'),
        ),
      ),
