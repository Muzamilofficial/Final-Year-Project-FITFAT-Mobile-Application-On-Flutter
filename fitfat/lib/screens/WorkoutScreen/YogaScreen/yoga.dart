...
import 'package:fitfat/screens/WorkoutScreen/YogaScreen/Plankposevideoscreen.dart';
import 'package:fitfat/screens/WorkoutScreen/YogaScreen/Treeposevideoscreen.dart';
...
import 'Bridgeposevideoscreen.dart';
import 'ChildposeVideoScreen.dart';
import 'Cobraposevideoscreen.dart';
import 'Corpseposevideoscreen.dart';
import 'FourLimbedStaffposevideoscreen.dart';
        ...
        children: [
          ...
          Container(
            child: InkWell(
                ...
                onTap: (() async {
                  var docname = 'Childpose' + getCurrentDate();
                  ...
                  .push(MaterialPageRoute(builder: (context) => ChildposeVideoScreen()));
                })),
          ),
          SizedBox(
            height: 20,
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Plankpose' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Plankposevideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Cobrapose' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Cobraposevideoscreen()));
              }),
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Treepose' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Treeposevideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Bridgepose' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Bridgeposevideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'Corpsepose' + getCurrentDate();
                CollectionReference users = FirebaseFirestore.instance
                    .collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                ...
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Corpseposevideoscreen()));
              }),
            ),
          ),
          SizedBox(
          ...
          Container(
            child: InkWell(
              ...
              onTap: (() async {
                var docname = 'FourLimbedStaffpose' + getCurrentDate();
                CollectionReference users =
                    FirebaseFirestore.instance.collection(FirebaseAuth.instance.currentUser!.email!);
                // Call the user's CollectionReference to add a new user
                await users.doc(docname).set({
                  'Email': FirebaseAuth.instance.currentUser!.email!,
                  'Exercise': 'FourLimbedStaffpose',
                  'Date': getCurrentDate(),
                });
                Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => FourLimbedStaffposevideoscreen()));
              }),
            ),
          ),
        ],
